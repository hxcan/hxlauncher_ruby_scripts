...
#         currentMapItem.applicationInformation << currentApplicationInformation #加入列表中
        ...
        currentMapItem.packageName='' #清空包名
        currentMapItem.activityName='' #清空活动名
#         currentMapItem
...
def loadWholeVoicePackageMap
    attachementFile=File.new("voicePackageNameMap.ost.migrate", "r") #创建附件图片文件。
...
attachementFile=File.new("voicePackageNameMap.ost.migrate.purge","w") #创建附件图片文件。
